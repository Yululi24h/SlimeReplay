...
public class WrapperPlayServerChunkData extends PacketWrapper<WrapperPlayServerChunkData> {
    private final static ChunkReader_v1_7 chunkReader_v1_7 = new ChunkReader_v1_7();
    private final static ChunkReader_v1_8 chunkReader_v1_8 = new ChunkReader_v1_8();
    private final static ChunkReader_v1_9 chunkReader_v1_9 = new ChunkReader_v1_9();
    private final static ChunkReader_v1_16 chunkReader_v1_16 = new ChunkReader_v1_16();
    private final static ChunkReader_v1_18 chunkReader_v1_18 = new ChunkReader_v1_18();
    ...
    public WrapperPlayServerChunkData(Column column, LightData lightData) {
        this(column, lightData, false, null);
    }

    public WrapperPlayServerChunkData(int chunkSize) {
        this();
        this.chunkSize = chunkSize;
    }

    public WrapperPlayServerChunkData(Column column, LightData lightData, int chunkSize) {
        this(column, lightData, false, chunkSize);
    }

    public WrapperPlayServerChunkData(Column column, LightData lightData, boolean ignoreOldData) {
        this(column, lightData, ignoreOldData, null);
    }

    public WrapperPlayServerChunkData(Column column, LightData lightData, boolean ignoreOldData, Integer chunkSize) {
        super(PacketType.Play.Server.CHUNK_DATA);
        this.column = column;
    ...
    public int getChunkSize() {
        return  column.getChunks().length;
    }
